  ...
  return (
    <div className="container">
      <div className="row mt-5">
        <div className="col-9">
          <h1 className="auction-heading">Featured Products</h1>
        </div>
      ...
      <div className="row mt-3">
        {FeaturedProduct.map((FeatureProduct, index) => (
          <div className="col-md-4" key={index}>
            <div className="card mb-3">
              ...
              <div className="card-body">
                <h5 className="card-title">{FeatureProduct.title}</h5>
                <p className="card-text auction-price">
                  {FeatureProduct.price}
                </p>
                <div className="card-subtitle mb-2 text-muted">
                  <span className="time">{FeatureProduct.TimePlaceHolder}</span>
                  <br />
                  <span className="time-left">{FeatureProduct.timeLeft}</span>
                  <br />
